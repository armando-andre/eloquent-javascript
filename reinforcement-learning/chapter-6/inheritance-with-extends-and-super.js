// Create a class called Animal with a constructor that takes a name and a method called eat which prints "[name] is eating.".
// Create a new class Dog that extends Animal.
